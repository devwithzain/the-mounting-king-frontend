				...
				<div className="w-fit flex items-center justify-center bg-[#1f1f3d] padding-y padding-x rounded-lg z-[999]">
					<div className="flex flex-col gap-8 items-center justify-center">
						<div className="flex flex-col gap-5 items-center justify-center">
							<h1 className="text-white text-center font-HyperspaceRace heading font-black leading-[100px] capitalize">
								Book Appointment <br /> With The Mounting Man
							</h1>
							<p className="w-1/2 text-white text-center font-Monstrate text-[18px] leading-normal">
