	...
	return (
		<>
			<div
				...
				<motion.div className="w-full flex justify-between rounded-[30px] relative -top-[45%] h-fit min-h-[500px] items-center transform origin-top xm:flex-col sm:flex-col bg-[#0D0D1E]">
					<div className="w-1/2 flex flex-col gap-5 relative sm:w-full xm:w-full md:w-full pl-14">
					...
					<motion.div
						...
						<div className="relative">
							...
							<div className="absolute top-0 left-0 z-50 w-full h-full flex items-center justify-center gap-4 p-5 backdrop-blur-md bg-black/30">
								...
								<Link
									to="/services"
									className="absolute right-5 bottom-5 flex items-center justify-center w-20 h-20 p-4 bg-white/20 rounded-full hover:rotate-[-45deg] transition-all duration-300 ease-in-out backdrop-blur-sm">
									<GoArrowUpRight
										size={30}
										strokeWidth={1}
			...
			<div
				...
				<motion.div className="w-full flex justify-between rounded-[30px] relative -top-[45%] h-fit min-h-[500px] items-center transform origin-top xm:flex-col sm:flex-col bg-[#1F1F3D]">
					<div className="w-1/2 flex flex-col gap-5 relative sm:w-full xm:w-full md:w-full pl-14">
						<div className="flex flex-col gap-3">
							<h1 className="text-[#F99A03] font-HyperspaceRace text-[35px] font-black leading-tight capitalize mb-2">
								<TextMask>{["Services We Offer"]}</TextMask>
					...
					<motion.div
						...
						<div className="relative">
							...
							<div className="absolute top-0 left-0 z-50 w-full h-full flex items-center justify-center gap-4 p-5 backdrop-blur-md bg-black/30">
								...
								<Link
									to="/services"
									className="hover:rotate-[-45deg] transition-all duration-300 ease-in-out absolute right-5 bottom-5 flex items-center justify-center w-20 h-20 p-4 bg-white/20 rounded-full backdrop-blur-sm">
									<GoArrowUpRight
										size={30}
										strokeWidth={1}
										className="text-white rotate-45"
