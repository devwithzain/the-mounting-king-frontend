...
export default function Footer() {
	return (
		<div className="w-full min-h-screen bg-[url('/footerBackground.png')] bg-cover bg-center bg-no-repeat py-10 relative">
				...
				<div className="w-full flex flex-col gap-20 rounded-[26px] bg-[radial-gradient(154.25%_82%_at_32.7%_40.44%,#2D2D51_0%,#00011A_57%,#0E0E30_100%)] py-10 px-20">
					<div className="w-full flex items-center justify-between rounded-lg p-10 bg-white/15 backdrop-blur-[5px]">
						...
						<div>
							<form
								action=""
								className="rounded-lg px-6 py-3 flex justify-between items-center bg-white gap-10">
								<div className="flex items-center gap-3">
									...
									<input
										type="text"
										className="text-[#0E0E30] font-Monstrate text-[20px] font-normal leading-tight tracking-tight placeholder:text-[#0E0E30] outline-none border-none"
										placeholder="Enter your email"
									/>
								</div>
								<button className="text-[#0E0E30] font-Monstrate text-[20px] font-normal leading-tight tracking-tight">
									Submit
								</button>
							</form>
						</div>
